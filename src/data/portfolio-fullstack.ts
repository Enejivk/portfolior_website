...
// Full Stack Developer Portfolio Data
export const personalInfo = {
  ...
  description:
    "Full Stack Developer with 4+ years building end-to-end web applications — from pixel-perfect frontends to robust backend APIs and cloud infrastructure",
  aboutDescription:
    "Versatile Full Stack Engineer skilled in scalable front-end architecture, backend API design, database management, and cloud deployment. Focused on delivering complete, production-ready solutions.",
...
export const experience = [
  {
    ...
    company: "JustiGuide",
    description:
      "Architected and built AI chat interface with real-time streaming, document management dashboard, and task management system. Developed backend APIs for AI-powered form auto-fill, integrated RESTful services, and optimized full-stack performance across all devices.",
  ...
  },
  {
    ...
    company: "Ecobank",
    description:
      "Built end-to-end loan eligibility platform — from backend API integration and data processing pipelines to interactive dashboards displaying customer financial data, balances, transactions, and risk indicators.",
  ...
  },
  {
    ...
    company: "Sentinel",
    description:
      "Developed client and service provider dashboards with full-stack ownership — built authentication flows, role-based access control, payment verification APIs, and managed state with Redux and Context API.",
...
export const openSource = [
  {
    ...
    period: "Dec 2025",
    description:
      "Improved responsive design across devices. Implemented text-to-speech interface and integrated backend voice processing APIs.",
  },
  {
    project: "Zulip",
    role: "Full Stack Contributor",
    period: "Nov 2025",
    description:
      "Improved UI layout and backend message handling. Updated role-based access logic and API behavior for cleaner interfaces.",
  },
  {
    project: "Cap",
    role: "Full Stack Contributor",
    period: "Sept 2025",
    description:
      "Fixed overlap and spacing issues. Enhanced timeline editor with precision controls, visual feedback, and backend data persistence.",
  },
];
